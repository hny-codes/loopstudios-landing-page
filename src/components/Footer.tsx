...
export default function Footer() {
  return (
    <footer className='bg-[--clr-black] py-16 sm:py-10 font-alata px-8'>
      <div className='flex flex-col sm:flex-row justify-center sm:justify-between sm:gap-4 text-[--clr-white] text-center sm:text-left max-w-[--max-width] mx-auto'>
        <div className='text-xl flex flex-col items-center sm:items-start'>
          <div>
          ...
          <div className='mt-10 mb-14 sm:mt-6 sm:mb-0 flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-12'>
        ...
        <div className='grid gap-4'>
          <div className='flex gap-4 justify-center sm:justify-end items-center'>
            <a href='#' className='underline-hover hover:after:scale-x-100'>
              <svg width='24' height='24' xmlns='http://www.w3.org/2000/svg' className='my-2'>
                <path
            ...
            <a href='#' className='underline-hover hover:after:scale-x-100'>
              <svg width='24' height='20' xmlns='http://www.w3.org/2000/svg' className='my-2'>
                <path
          ...
          <div className='text-[--clr-dark-gray] mt-2 sm:mt-0 sm:self-end sm:text-right'>
