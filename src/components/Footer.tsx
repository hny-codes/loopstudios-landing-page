...
export default function Footer() {
  return (
    <footer className='bg-[--clr-black] py-16 sm:py-10 font-alata'>
      <div className='flex flex-col sm:flex-row justify-center sm:justify-between sm:gap-4 text-[--clr-white] text-center sm:text-left max-w-[--max-width] mx-auto px-6'>
